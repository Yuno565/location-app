...
function seedData(db) {
  ...
  db.query("INSERT INTO users (name, email, password, role, agency_name) VALUES ?", [users], (err) => {
    ...
    const vehicles = [
      ...
      ["v3", "Dacia", "Sandero Stepway", 2022, 250, "Agadir", "Économique", "Manuelle", "Essence", 5, "https://images.unsplash.com/photo-1471444928139-48c5bf5173f8?w=800&q=80", "Voiture économique et fiable pour découvrir Agadir.", true, "EcoCar Agadir"],
